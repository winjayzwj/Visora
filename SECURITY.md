...
Visora AI is in active development. Security fixes are accepted for the
...
2. If a private repository report is not available, email `winjayzwj@gmail.com`
   with the subject `[Visora security]`.
