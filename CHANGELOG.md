...
- [优化] 登录页第三方登录按钮增加间隔，左侧新增创作流信号条，代码视觉组件改为 HeroUI Card 表面。
...
- [优化] 首页 AI 图像、AI 视频、打开画布及登录主按钮接入 React Bits SpecularButton 跟随鼠标高光效果。
...
- [调整] 登录页与首页改为居中双栏创作系统卡片，采用主题渐变背景与仿 macOS 彩色代码窗口；未登录时顶部账户入口直接跳转登录页。
